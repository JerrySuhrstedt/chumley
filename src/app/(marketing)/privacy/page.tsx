...
export const metadata: Metadata = {
  title: "Privacy Policy | UnCRM",
  description:
    "How SumoLab LLC collects, uses, shares, and protects personal information in the UnCRM service.",
};
