...
const SHOWCASE: {
...
}[] = [
  {
    ...
    body: "Your board arrives with sample deals already on it and a two-step tour that points at exactly what to touch. There is no setup wizard, no fields to configure, and nothing to import before you can start. The first real deal usually lands before the first coffee is finished.",
  ...
  },
  {
    ...
    body: "Every deal is a card, every stage is a column, and moving a deal is one drag, on a laptop or a phone. No forms, no status dropdowns, no save button. If you have ever moved a sticky note across a whiteboard, you already know how to run this pipeline.",
  ...
  },
  {
    ...
    body: "Tap the phone icon and your phone is dialing. Tap text or email and a message opens with their details filled in, and your saved templates one tap away. The distance between deciding to follow up and actually doing it is about half a second, which is the entire trick to following up.",
  ...
  },
  {
    ...
    body: "The moment you tap call, text or email, the touch is on the record: who, what, and when, attributed to you. No end-of-day data entry, no reconstructing the week from memory on Friday. The history every CRM promises, without the typing every CRM actually requires.",
  ...
  },
  {
    ...
    body: "One screen answers the morning questions: what did we win, what is moving, and who needs a call before lunch. No report builder, no filters to learn. The numbers are computed from the board you already keep, so they are always current and nobody has to compile anything.",
