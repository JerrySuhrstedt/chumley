...
export const metadata: Metadata = {
  title: "Terms of Service | UnCRM",
  description:
    "The agreement between SumoLab LLC and users of the UnCRM sales pipeline service.",
};
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro={`These Terms of Service ("Terms") form a binding agreement between you and ${COMPANY.legalName} ("SumoLab," "we," "us," or "our") governing your access to and use of ${COMPANY.product}, our sales pipeline software, together with the uncrm.app website and any related services (collectively, the "Service"). By creating an account, accessing, or using the Service, you agree to these Terms. If you do not agree, do not use the Service.`}
    >
