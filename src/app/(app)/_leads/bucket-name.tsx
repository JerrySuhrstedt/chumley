  ...
  if (editing) {
    return (
      <input
        ...
        className="w-full min-w-0 rounded border border-[var(--brand)] bg-white px-1.5 py-0.5 text-xl font-semibold text-[var(--board-ink)] outline-none focus:ring-3 focus:ring-[var(--brand)]/30"
      />
    );
  }
